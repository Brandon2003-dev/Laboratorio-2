...
namespace Lab_2.DAO
{
    public class CrudNota
    {
        ...
        public void CalcularResultado(Nota notas)
        {
            ...
            var Periodo1 = (notas.Lab_1 * Convert.ToDecimal(0.4)) + (notas.Parcial_1 * Convert.ToDecimal(0.6));
            var Periodo2 = (notas.Lab_2 * Convert.ToDecimal(0.4)) + (notas.Parcial_2 * Convert.ToDecimal(0.6));
            var Periodo3 = (notas.Lab_3 * Convert.ToDecimal(0.4)) + (notas.Parcial_3 * Convert.ToDecimal(0.6));
