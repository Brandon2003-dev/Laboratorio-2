...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-34LHMKA\\SQLEXPRESS;Database=NotaEstudiante;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Nota>(entity =>
        {
            ...
            entity.Property(e => e.Lab_1).HasColumnType("decimal(18, 0)");
            entity.Property(e => e.La_2).HasColumnType("decimal(18, 0)");
            entity.Property(e => e.Lab_3).HasColumnType("decimal(18, 0)");
